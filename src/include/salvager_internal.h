...
#define ASTEROID_SPAWN_LIFETIME 4
#define ASTEROID_COLLISION_DAMAGE 5
...
#define PLAYER_FRICTION 0.99

#define DEFAULT_COOLDOWN_PLAYER_SHOT 0.5
#define LEVEL_REQUIREMENT 100
#define LEVEL_MULTIPLIER 2

#define COLLECTION_INCREASE_LEVELUP 5
#define FIRE_RATE_MULTIPLIER_LEVELUP 0.9
#define DROP_RATE_MULTIPLIER_LEVEL_UP 1.1
